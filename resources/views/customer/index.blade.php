        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="left-sidebar">
                    <h2>Category</h2>
                @include('customer.sidebar.category_products')

                <!--brands_products-->
                @include('customer.sidebar.brands_products')
                <!--/brands_products-->

                    <div class="price-range"><!--price-range-->
                        <h2>Price Range</h2>
                        <div class="well text-center">
                            <label for="sl2"></label><input type="text" class="span2" value="" data-slider-min="0"
                                                            data-slider-max="600"
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="category-tab"><!--sidebar-tab-->
                    <div class="col-sm-12">
